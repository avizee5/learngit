...
f.setAttribute("class","appsflyer-banner-close-img");f.setAttribute("src","img/close.png");f.setAttribute("alt","close");var d="var bannerWrapper = document.getElementById('"+a+"'); while (bannerWrapper.firstChild) {bannerWrapper.removeChild(bannerWrapper.firstChild);}";a=document.createElement("DIV");a.setAttribute("class","appsflyer-banner-close-container");a.setAttribute("onclick",d);a.appendChild(f);d=document.createElement("DIV");d.setAttribute("class","appsflyer-banner-title");d.innerHTML=c.title;var e=document.createElement("DIV");
e.setAttribute("class","appsflyer-banner-subtitle");e.innerHTML=c.subtitle;f=document.createElement("DIV");f.setAttribute("class","appsflyer-banner-text-container");f.appendChild(d);f.appendChild(e);e=document.createElement("IMG");e.setAttribute("class","appsflyer-banner-icon-img");e.setAttribute("src",c.app_icon);e.setAttribute("alt",c.alt);d=document.createElement("DIV");d.setAttribute("class","appsflyer-banner-icon-container");d.appendChild(e);e="window.location.replace('"+b+"')";b=document.createElement("BUTTON");b.setAttribute("class",
